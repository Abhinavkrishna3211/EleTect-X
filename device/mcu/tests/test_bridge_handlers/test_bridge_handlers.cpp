...
// led_channel_for_pattern_id() (ENGINEERING_CONVENTIONS.md 4). The four
// bridge_* adapters themselves call real actuator/sensor code
// (drive_horn/drive_led/pulse_ir/geophone_ok) already covered by their
// own drivers and rule_gate's tests; they are not registered with
// Bridge.provide() anywhere (see bridge_handlers.h), so there is no live
// wire input to test them against yet, host or hardware.
