...
6. **Caution, stated plainly so it isn't oversold**: "never let them habituate" is not a claim this
   ...
   architecture's fully-cited literature review, this claim should not go into DFO or public materials
...
rather than fires one fixed maximal response forever. Say this plainly in any public/DFO materials or
...
- The "never habituate" framing should not appear in public/DFO materials as a proven claim. This ADR
