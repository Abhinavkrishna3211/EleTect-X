...
event footage is exactly the deliverable this trial needs; auto-deleting any of
...
- **Keep the current 5-frame JPEG burst, do nothing.** Rejected — doesn't serve the explicit ask (a
  continuous story of the encounter), and the public-footage goal is a real, stated priority now, not a
