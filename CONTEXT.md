...
## 10. Deadlines
Robu submission **filed 23 Aug** (done) · Hackster submission **13 Sept** (updated from 30 Aug) · **Field deployment with DFO Kothamangalam: complete trial by 2 Sept** (updated from the original 20 Aug/10-day window — see `hardware/bom/procurement-status.md` §6) · Frontend design-prototype window **closed 12 Jul**.
