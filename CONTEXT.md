...
## 10. Deadlines
Robu submission **filed 23 Aug** (done) · Hackster submission **13 Sept** (updated from 30 Aug) · **Field deployment with DFO Kothamangalam: complete trial by 5 Sept** (moved from 2 Sept — user-confirmed 1 Sept, a decision that had not previously reached the written record; 2 Sept had itself replaced the original 20 Aug/10-day window — see `hardware/bom/procurement-status.md` §6) · Frontend design-prototype window **closed 12 Jul**.
